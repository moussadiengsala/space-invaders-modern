...
export class ResourceManager {
    ...
    async resourceLoader() {
        await Promise.all([
            ...
            this.loadImage(
                "player.100",
                "/assets/characters/main-ship-base/PNGs/full-health.png"
            ),
            this.loadImage(
                "player.75",
                "/assets/characters/main-ship-base/PNGs/slight-damage.png"
            ),
            this.loadImage(
                "player.50",
                "/assets/characters/main-ship-base/PNGs/damaged.png"
            ),
            this.loadImage(
                "player.25",
                "/assets/characters/main-ship-base/PNGs/very-damage.png"
            ),
            this.loadImage(
                "player.0",
                "/assets/characters/main-ship-base/PNGs/very-damage.png"
            ...
            this.loadImage(
                "enemie.1.100",
                "/assets/characters/enemies/soldier/enemy-1/base.png"
            ),
            this.loadImage(
                "enemie.1.0",
                "/assets/characters/enemies/soldier/enemy-1/destruction.png"
            ),
            this.loadImage(
                "enemie.2.100",
                "/assets/characters/enemies/soldier/enemy-2/base.png"
            ),
            this.loadImage(
                "enemie.2.0",
                "/assets/characters/enemies/soldier/enemy-2/destruction.png"
            ),

            // weapons
            this.loadImage(
                "weapon.bigSpaceGun",
                "/assets/characters/weapons/PNGs/weapons-big-space-gun.png"
            ),
            this.loadImage(
                "weapon.autoCannon",
                "/assets/characters/weapons/PNGs/weapons-auto-cannon.png"
            ),
            this.loadImage(
                "weapon.zapper",
                "/assets/characters/weapons/PNGs/weapons-zapper.png"
            ),
            this.loadImage(
                "weapon.rockets",
                "/assets/characters/weapons/PNGs/weapons-rockets.png"
            ),

            // projectile
            this.loadImage(
                "projectile.cannon",
                "/assets/characters/projectile/PNGs/auto-cannon.png"
            ),
            this.loadImage(
                "projectile.bigSpaceGun",
                "/assets/characters/projectile/PNGs/big-space-gun.png"
            ),
            this.loadImage(
            ...
            this.loadImage(
                "projectile.rockets",
                "/assets/characters/projectile/PNGs/rockets.png"
            ),
            this.loadImage(
                "projectile.zapper",
                "/assets/characters/projectile/PNGs/zapper.png"
            ),

            // exhausts
            this.loadImage(
                "exhaust.exhaust",
                "/assets/characters/exhausts/PNGs/exhaust10.png"
            ),

            // exhausts engine
            this.loadImage(
                "exhaust.engine",
                "/assets/characters/engin-exhausts/PNGs/engin-exhausts3.png"
            ),
            ...
            this.loadAudio(
                "gameOver",
                "../../assets/audio/mixkit-laser-game-over-1946.wav"
            ),
